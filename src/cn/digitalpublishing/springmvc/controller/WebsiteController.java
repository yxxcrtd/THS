...
public class WebsiteController extends BaseController {
	...
	public ModelAndView index(PProductForm form, @RequestParam(value = "p", required = true, defaultValue = "1") int p, @RequestParam(value = "c", required = false) String c) throws Exception {
